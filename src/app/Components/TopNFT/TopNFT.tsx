...
export default function TopNFT() {
  return (
    <main className="flex justify-center items-end gap-5">
      <section className="w-[420px] flex flex-col  gap-4 border border-nft-light-gray rounded-2xl pb-4">
        <Image
        ...
        <div className="px-5 my-4">
          <ToggleButton
            type="submit"
            className="w-[367px] bg-nft-royal-blue-gr text-white cursor-pointer transition-transform hover:scale-105"
          >
            Get started
          </ToggleButton>
        </div>
      ...
      <section className="ml-4 w-[440px] flex flex-col items-center  gap-4 border border-nft-light-gray rounded-2xl px-4 py-6">
        ...
        <ToggleButton
          type="button"
          className="w-[367px] cursor-pointer border border-nft-deep-gray text-white transition-transform hover:scale-105 mt-3"
        >
          Show me more
        </ToggleButton>
      </section>
