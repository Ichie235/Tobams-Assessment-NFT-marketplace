...
export default function TopNFT() {
  return (
    <main className="flex flex-col  md:flex-row md:flex-wrap items-end gap-5">
      ...
      <section className="w-full md:w-[350px] lg:w-[300px] xl:w-[420px] flex flex-col  gap-4 pb-4">
        <Image
        ...
        />
        <div className="border-r border-l border-b border-nft-light-gray  rounded-b-2xl">
          <div className="px-6 ">
